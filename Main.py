...
Melhores_Jazz = Playlist("Melhores Jazz",1,"New York","11111111111",0,1,"2023-02-19")
...
#Objeto2DAO.consulta_musica(New_York)
...
#Objeto5DAO.inserir_categoria(Melhores_Jazz)
